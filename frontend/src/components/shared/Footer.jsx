      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100088688816851" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://www.linkedin.com/in/md-faiz-ansari-b16798309/" className="hover:text-gray-400" aria-label="LinkedIn">
